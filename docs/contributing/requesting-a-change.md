...
P-KISS-SBC is a simple and robust SBC. We understand that our
...
your idea is a good fit for P-KISS-SBC and matches the project's
[philosophy] and tone.
...
If you have seen your idea implemented in another SBC or SIP Proxy, 
make sure to collect enough information on its implementation before
...
idea is relevant to P-KISS-SBC and must be implemented here, and not
...
> P-KISS-SBC, which helps us maintainers evaluate and triage 
> change requests.
...
information to review your idea for P-KISS-SBC.
