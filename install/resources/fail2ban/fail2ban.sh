...
cp resources/fail2ban/apache-404.conf /etc/fail2ban/filter.d/apache-404.conf
cp resources/fail2ban/apache-dos.conf /etc/fail2ban/filter.d/apache-dos.conf
