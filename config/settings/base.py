...
# (pyfreebilling/config/settings/base.py - 3 = pyfreebilling/)
APPS_DIR = ROOT_DIR / "pyfreebilling"
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                ...
                "pyfreebilling.utils.context_processors.settings_context",
            ],
        },
    },
]
...
FIXTURE_DIRS = (str(APPS_DIRi / "fixtures"),)
