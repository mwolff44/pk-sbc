...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'RoutesDid', fields ['contract_did']
        db.delete_unique('did_routes', ['contract_did_id'])

        # Adding unique constraint on 'RoutesDid', fields ['contract_did', 'order']
        db.create_unique('did_routes', ['contract_did_id', 'order'])


    def backwards(self, orm):
        # Removing unique constraint on 'RoutesDid', fields ['contract_did', 'order']
        db.delete_unique('did_routes', ['contract_did_id', 'order'])

        # Adding unique constraint on 'RoutesDid', fields ['contract_did']
        db.create_unique('did_routes', ['contract_did_id'])
    ...
    models = {
        ...
        'did.did': {
            ...
            'plan': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['did.ProviderRatesDid']"}),
        ...
        'did.routesdid': {
            ...
            'contract_did': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['did.ContractDid']"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
