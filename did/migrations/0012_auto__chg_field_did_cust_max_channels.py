...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Did.cust_max_channels'
        db.alter_column('did', 'cust_max_channels', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Did.cust_max_channels'
        db.alter_column('did', 'cust_max_channels', self.gf('django.db.models.fields.PositiveIntegerField')())
