...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RoutesDid'
        db.create_table('did_routes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contract_did', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['did.ContractDid'], unique=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('type', self.gf('django.db.models.fields.CharField')(default='m', max_length=2)),
            ('trunk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.CustomerDirectory'])),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('did', ['RoutesDid'])


    def backwards(self, orm):
        # Deleting model 'RoutesDid'
        db.delete_table('did_routes')
    ...
    models = {
        ...
        'did.routesdid': {
            ...
            'trunk': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pyfreebill.CustomerDirectory']"}),
