...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CustomerRatesDid.customer'
        db.delete_column('customer_rates_did', 'customer_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CustomerRatesDid.customer'
        raise RuntimeError("Cannot reverse this migration. 'CustomerRatesDid.customer' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CustomerRatesDid.customer'
        db.add_column('customer_rates_did', 'customer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.Company']),
                      keep_default=False)
