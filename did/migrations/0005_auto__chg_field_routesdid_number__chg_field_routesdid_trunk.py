...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RoutesDid.number'
        db.alter_column('did_routes', 'number', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'RoutesDid.trunk'
        db.alter_column('did_routes', 'trunk_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.CustomerDirectory'], null=True))

    def backwards(self, orm):

        # Changing field 'RoutesDid.number'
        db.alter_column('did_routes', 'number', self.gf('django.db.models.fields.CharField')(default=1, max_length=30))

        # Changing field 'RoutesDid.trunk'
        db.alter_column('did_routes', 'trunk_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pyfreebill.CustomerDirectory']))
