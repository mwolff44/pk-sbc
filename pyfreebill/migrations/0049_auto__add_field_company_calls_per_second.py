...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.calls_per_second'
        db.add_column('company', 'calls_per_second',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.calls_per_second'
        db.delete_column('company', 'calls_per_second')
