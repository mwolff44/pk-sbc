...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CalleridPrefixList'
        db.create_table('callerid_prefix_list', (
        ...
        db.send_create_signal(u'pyfreebill', ['CalleridPrefixList'])

        # Adding model 'CallerIDPrefix'
        db.create_table('caller_id_prefix', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('calleridprefixlist', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.CalleridPrefixList'])),
            ('prefix', self.gf('django.db.models.fields.CharField')(max_length=30, db_index=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'pyfreebill', ['CallerIDPrefix'])

        # Adding unique constraint on 'CallerIDPrefix', fields ['calleridprefixlist', 'prefix']
        db.create_unique('caller_id_prefix', ['calleridprefixlist_id', 'prefix'])

        # Adding field 'RateCard.callerid_filter'
        db.add_column('ratecard', 'callerid_filter',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=2),
                      keep_default=False)

        # Adding field 'RateCard.callerid_list'
        db.add_column('ratecard', 'callerid_list',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.CalleridPrefixList'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'CallerIDPrefix', fields ['calleridprefixlist', 'prefix']
        db.delete_unique('caller_id_prefix', ['calleridprefixlist_id', 'prefix'])

        # Deleting model 'CalleridPrefixList'
        db.delete_table('callerid_prefix_list')

        # Deleting model 'CallerIDPrefix'
        db.delete_table('caller_id_prefix')

        # Deleting field 'RateCard.callerid_filter'
        db.delete_column('ratecard', 'callerid_filter')

        # Deleting field 'RateCard.callerid_list'
        db.delete_column('ratecard', 'callerid_list_id')
