...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerRates.minimal_time'
        db.add_column('customer_rates', 'minimal_time',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerRates.minimal_time'
        db.delete_column('customer_rates', 'minimal_time')
    ...
    models = {
        ...
        u'pyfreebill.customerrates': {
            ...
            'minimal_time': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'prefix': ('django.db.models.fields.CharField', [], {'max_length': '30', 'db_index': 'True'}),
