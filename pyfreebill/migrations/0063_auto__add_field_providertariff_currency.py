...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProviderTariff.currency'
        db.add_column('provider_tariff', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=46, to=orm['currencies.Currency']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProviderTariff.currency'
        db.delete_column('provider_tariff', 'currency_id')
