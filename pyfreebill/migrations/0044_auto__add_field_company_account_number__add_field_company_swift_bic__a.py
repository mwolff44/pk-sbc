...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('company', 'account_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.swift_bic'
        db.add_column('company', 'swift_bic',
                      self.gf('django_iban.fields.SWIFTBICField')(max_length=11, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.iban'
        db.add_column('company', 'iban',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('company', 'account_number')

        # Deleting field 'Company.swift_bic'
        db.delete_column('company', 'swift_bic')

        # Deleting field 'Company.iban'
        db.delete_column('company', 'iban')
