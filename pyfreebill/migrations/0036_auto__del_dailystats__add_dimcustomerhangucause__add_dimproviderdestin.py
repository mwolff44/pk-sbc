...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'DailyStats'
        db.delete_table('daily_stats')

        # Adding model 'DimCustomerHangucause'
        db.create_table('dim_customer_hangupcause', (
        ...
        db.send_create_signal(u'pyfreebill', ['DimCustomerHangucause'])

        # Adding model 'DimProviderDestination'
        db.create_table('dim_provider_destination', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'pyfreebill', ['DimProviderDestination'])

        # Adding model 'DimCustomerDestination'
        db.create_table('dim_customer_destination', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.Company'])),
            ('destination', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.DimDate'])),
        ...
        db.send_create_signal(u'pyfreebill', ['DimCustomerDestination'])
        ...
        # Adding model 'DimProviderHangucause'
        db.create_table('dim_provider_hangupcause', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('provider', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.Company'])),
            ('hangupcause', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('date', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.DimDate'])),
        ...
        db.send_create_signal(u'pyfreebill', ['DimProviderHangucause'])

        # Adding model 'DimDate'
        db.create_table('date_dimension', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('day', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('day_of_week', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('month', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('month_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('quarter', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('quarter_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('year', self.gf('django.db.models.fields.CharField')(max_length=4)),
        ))
        db.send_create_signal(u'pyfreebill', ['DimDate'])


    def backwards(self, orm):
        # Adding model 'DailyStats'
        db.create_table('daily_stats', (
            ('max_duration', self.gf('django.db.models.fields.IntegerField')()),
            ('total_duration', self.gf('django.db.models.fields.IntegerField')()),
            ('min_duration', self.gf('django.db.models.fields.IntegerField')()),
            ('avg_duration', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal(u'pyfreebill', ['DailyStats'])

        # Deleting model 'DimCustomerHangucause'
        db.delete_table('dim_customer_hangupcause')

        # Deleting model 'DimProviderDestination'
        db.delete_table('dim_provider_destination')

        # Deleting model 'DimCustomerDestination'
        db.delete_table('dim_customer_destination')

        # Deleting model 'DimHangupcauseDestination'
        db.delete_table('dim_hangupcause_destination')

        # Deleting model 'DimProviderHangucause'
        db.delete_table('dim_provider_hangupcause')

        # Deleting model 'DimDate'
        db.delete_table('date_dimension')
    ...
    models = {
        ...
        u'pyfreebill.dimdate': {
            ...
            'month_name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'quarter': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'quarter_name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'year': ('django.db.models.fields.CharField', [], {'max_length': '4'})
        },
        u'pyfreebill.dimhangupcausedestination': {
            'Meta': {'ordering': "('date', 'hangupcause', 'destination')", 'object_name': 'DimHangupcauseDestination', 'db_table': "'dim_hangupcause_destination'"},
            'avg_duration': ('django.db.models.fields.IntegerField', [], {}),
            'date': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pyfreebill.DimDate']"}),
            'destination': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'hangupcause': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
