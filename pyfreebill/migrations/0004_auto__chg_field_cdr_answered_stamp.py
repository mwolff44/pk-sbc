...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CDR.answered_stamp'
        db.alter_column('cdr', 'answered_stamp', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CDR.answered_stamp'
        raise RuntimeError("Cannot reverse this migration. 'CDR.answered_stamp' and its values cannot be restored.")
