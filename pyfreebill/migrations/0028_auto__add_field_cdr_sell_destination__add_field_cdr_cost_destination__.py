...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CDR.sell_destination'
        db.add_column('cdr', 'sell_destination',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CDR.cost_destination'
        db.add_column('cdr', 'cost_destination',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CustomerRates.destination'
        db.add_column('customer_rates', 'destination',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProviderRates.destination'
        db.add_column('provider_rates', 'destination',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CDR.sell_destination'
        db.delete_column('cdr', 'sell_destination')

        # Deleting field 'CDR.cost_destination'
        db.delete_column('cdr', 'cost_destination')

        # Deleting field 'CustomerRates.destination'
        db.delete_column('customer_rates', 'destination')

        # Deleting field 'ProviderRates.destination'
        db.delete_column('provider_rates', 'destination')
    ...
    models = {
        ...
        u'pyfreebill.cdr': {
            ...
            'cost_destination': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'null': 'True', 'blank': 'True'}),
            ...
            'sell_destination': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'null': 'True', 'blank': 'True'}),
