...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoipSwitch.esl_listen_ip'
        db.add_column('voip_switch', 'esl_listen_ip',
                      self.gf('django.db.models.fields.CharField')(default='127.0.0.1', max_length=100),
                      keep_default=False)

        # Adding field 'VoipSwitch.esl_listen_port'
        db.add_column('voip_switch', 'esl_listen_port',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default='8021'),
                      keep_default=False)

        # Adding field 'VoipSwitch.esl_password'
        db.add_column('voip_switch', 'esl_password',
                      self.gf('django.db.models.fields.CharField')(default='ClueCon', max_length=30),
                      keep_default=False)

        # Adding index on 'ProviderRates', fields ['digits', 'enabled', 'provider_tariff']
        db.create_index('provider_rates', ['digits', 'enabled', 'provider_tariff_id'])


    def backwards(self, orm):
        # Removing index on 'ProviderRates', fields ['digits', 'enabled', 'provider_tariff']
        db.delete_index('provider_rates', ['digits', 'enabled', 'provider_tariff_id'])

        # Deleting field 'VoipSwitch.esl_listen_ip'
        db.delete_column('voip_switch', 'esl_listen_ip')

        # Deleting field 'VoipSwitch.esl_listen_port'
        db.delete_column('voip_switch', 'esl_listen_port')

        # Deleting field 'VoipSwitch.esl_password'
        db.delete_column('voip_switch', 'esl_password')
