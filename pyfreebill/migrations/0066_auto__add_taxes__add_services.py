...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('services', (
            ...
            ('period', self.gf('django.db.models.fields.CharField')(default='false', max_length=100)),
            ('vat', self.gf('django.db.models.fields.related.ForeignKey')(related_name='vatservices', to=orm['pyfreebill.Taxes'])),
            ('tax1', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tax1', null=True, to=orm['pyfreebill.Taxes'])),
            ('tax2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='tax2', null=True, to=orm['pyfreebill.Taxes'])),
            ('account_code', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('comment', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
    ...
    models = {
        ...
        u'pyfreebill.services': {
            ...
            'period': ('django.db.models.fields.CharField', [], {'default': "'false'", 'max_length': '100'}),
