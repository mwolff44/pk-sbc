...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DimCustomerSipHangupcause'
        ...
        db.send_create_signal(u'pyfreebill', ['DimCustomerSipHangupcause'])

        # Adding model 'DimProviderSipHangupcause'
        ...
        db.send_create_signal(u'pyfreebill', ['DimProviderSipHangupcause'])

        # Adding model 'DimProviderHangupcause'
        ...
        db.send_create_signal(u'pyfreebill', ['DimProviderHangupcause'])

        # Adding model 'DimCustomerHangupcause'
        ...
        db.send_create_signal(u'pyfreebill', ['DimCustomerHangupcause'])

        # Adding field 'CustomerDirectory.codecs'
        db.add_column('customer_directory', 'codecs',
                      self.gf('django.db.models.fields.CharField')(default='ALL', max_length=100),
                      keep_default=False)


        # Changing field 'DimDate.date'
        db.alter_column('date_dimension', 'date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DimCustomerSipHangupcause'
        db.delete_table('dim_customer_sip_hangupcause')

        # Deleting model 'DimProviderSipHangupcause'
        db.delete_table('dim_provider_sip_hangupcause')

        # Deleting model 'DimProviderHangupcause'
        db.delete_table('dim_provider_hangupcause')

        # Deleting model 'DimCustomerHangupcause'
        db.delete_table('dim_customer_hangupcause')

        # Deleting field 'CustomerDirectory.codecs'
        db.delete_column('customer_directory', 'codecs')


        # Changing field 'DimDate.date'
        db.alter_column('date_dimension', 'date', self.gf('django.db.models.fields.DateField')())
