...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('company', 'about', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Company.vat_number'
        db.alter_column('company', 'vat_number', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'CompanyBalanceHistory.description'
        db.alter_column('company_balance_history', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'CompanyBalanceHistory.reference'
        db.alter_column('company_balance_history', 'reference', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Company.about'
        db.alter_column('company', 'about', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Company.vat_number'
        db.alter_column('company', 'vat_number', self.gf('django.db.models.fields.TextField')())

        # Changing field 'CompanyBalanceHistory.description'
        db.alter_column('company_balance_history', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'CompanyBalanceHistory.reference'
        db.alter_column('company_balance_history', 'reference', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'pyfreebill.sofiagateway': {
            ...
            'prefix': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '15', 'blank': 'True'}),
            'proxy': ('django.db.models.fields.CharField', [], {'default': "'/32'", 'max_length': '48'}),
