...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('taxes')

        # Deleting model 'Services'
        db.delete_table('services')

        # Deleting model 'Subscriptions'
        db.delete_table('subscriptions')

        # Adding field 'Company.vat_number_validated'
        db.add_column('company', 'vat_number_validated',
    ...
    def backwards(self, orm):
        ...
        db.create_table('taxes', (
            ...
            ('taxes', self.gf('django.db.models.fields.CharField')(default='False', max_length=100)),
            ('percentage', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=4)),
            ('account_code', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True)),
        ))
        db.send_create_signal(u'pyfreebill', ['Taxes'])

        # Adding model 'Services'
        db.create_table('services', (
            ('comment', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('type_service', self.gf('django.db.models.fields.CharField')(default='periodic', max_length=100)),
            ('tax2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tax2', null=True, to=orm['pyfreebill.Taxes'], blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('reference', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('period', self.gf('django.db.models.fields.CharField')(default='monthly', max_length=100)),
            ('currency', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['currencies.Currency'])),
            ('unit_cost', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=4)),
            ('tax1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tax1', null=True, to=orm['pyfreebill.Taxes'], blank=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('account_code', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vat', self.gf('django.db.models.fields.related.ForeignKey')(related_name='vatservices', to=orm['pyfreebill.Taxes'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
        ))
        db.send_create_signal(u'pyfreebill', ['Services'])
        ...
        db.create_table('subscriptions', (
            ...
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='customer', to=orm['pyfreebill.Company'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='services', to=orm['pyfreebill.Services'])),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('date_start', self.gf('django.db.models.fields.DateTimeField')()),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=4)),
        ))
        db.send_create_signal(u'pyfreebill', ['Subscriptions'])

        # Deleting field 'Company.vat_number_validated'
        db.delete_column('company', 'vat_number_validated')
