...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CDR.effective_duration'
        db.add_column('cdr', 'effective_duration',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'CDR.billsec'
        db.add_column('cdr', 'billsec',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'CDR.total_sell'
        db.add_column('cdr', 'total_sell',
                      self.gf('django.db.models.fields.DecimalField')(default='0', null=True, max_digits=11, decimal_places=5),
                      keep_default=False)

        # Adding field 'CDR.total_cost'
        db.add_column('cdr', 'total_cost',
                      self.gf('django.db.models.fields.DecimalField')(default='0', null=True, max_digits=11, decimal_places=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CDR.effective_duration'
        db.delete_column('cdr', 'effective_duration')

        # Deleting field 'CDR.billsec'
        db.delete_column('cdr', 'billsec')

        # Deleting field 'CDR.total_sell'
        db.delete_column('cdr', 'total_sell')

        # Deleting field 'CDR.total_cost'
        db.delete_column('cdr', 'total_cost')
