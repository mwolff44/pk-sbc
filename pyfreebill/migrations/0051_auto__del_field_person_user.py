...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('contacts_people', 'user_id')


    def backwards(self, orm):
        # Adding field 'Person.user'
        db.add_column('contacts_people', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pyfreebill.CustomUser'], unique=True, null=True, blank=True),
                      keep_default=False)
