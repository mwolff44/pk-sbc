...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AclNodes.list'
        db.delete_column('acl_nodes', 'list_id')

        # Adding field 'AclNodes.acllist'
        db.add_column('acl_nodes', 'acllist',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pyfreebill.AclLists']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AclNodes.list'
        db.add_column('acl_nodes', 'list',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pyfreebill.AclLists']),
                      keep_default=False)

        # Deleting field 'AclNodes.acllist'
        db.delete_column('acl_nodes', 'acllist_id')
