...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Services.type_service'
        db.add_column('services', 'type_service',
                      self.gf('django.db.models.fields.CharField')(default='periodic', max_length=100),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Services.type_service'
        db.delete_column('services', 'type_service')
