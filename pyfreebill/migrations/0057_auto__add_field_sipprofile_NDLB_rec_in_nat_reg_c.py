...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SipProfile.NDLB_rec_in_nat_reg_c'
        db.add_column('sip_profile', 'NDLB_rec_in_nat_reg_c',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SipProfile.NDLB_rec_in_nat_reg_c'
        db.delete_column('sip_profile', 'NDLB_rec_in_nat_reg_c')
