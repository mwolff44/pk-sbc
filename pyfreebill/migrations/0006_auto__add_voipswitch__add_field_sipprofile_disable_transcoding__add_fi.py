...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'pyfreebill', ['VoipSwitch'])

        # Adding field 'SipProfile.disable_transcoding'
        db.add_column('sip_profile', 'disable_transcoding',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'SipProfile.inbound_codec_prefs'
        db.add_column('sip_profile', 'inbound_codec_prefs',
                      self.gf('django.db.models.fields.CharField')(default='G729,PCMU,PCMA', max_length=100),
                      keep_default=False)

        # Adding field 'SipProfile.outbound_codec_prefs'
        db.add_column('sip_profile', 'outbound_codec_prefs',
                      self.gf('django.db.models.fields.CharField')(default='G729,PCMU,PCMA', max_length=100),
                      keep_default=False)

        # Adding field 'CDR.switchname'
        db.add_column('cdr', 'switchname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True),
                      keep_default=False)

        # Adding field 'CDR.switch_ipv4'
        db.add_column('cdr', 'switch_ipv4',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SipProfile.disable_transcoding'
        db.delete_column('sip_profile', 'disable_transcoding')

        # Deleting field 'SipProfile.inbound_codec_prefs'
        db.delete_column('sip_profile', 'inbound_codec_prefs')

        # Deleting field 'SipProfile.outbound_codec_prefs'
        db.delete_column('sip_profile', 'outbound_codec_prefs')

        # Deleting field 'CDR.switchname'
        db.delete_column('cdr', 'switchname')

        # Deleting field 'CDR.switch_ipv4'
        db.delete_column('cdr', 'switch_ipv4')
