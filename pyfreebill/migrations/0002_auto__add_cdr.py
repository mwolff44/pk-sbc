...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cdr', (
            ...
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='customer_related', to=orm['pyfreebill.Company'])),
            ('customer_ip', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('caller_id_number', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('destination_number', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('chan_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('start_stamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('answered_stamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_stamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('duration', self.gf('django.db.models.fields.IntegerField')()),
            ('billsec', self.gf('django.db.models.fields.IntegerField')()),
            ('read_codec', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('write_codec', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('hangup_cause', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('hangup_cause_q850', self.gf('django.db.models.fields.IntegerField')()),
            ('gateway', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.SofiaGateway'])),
            ...
            ('init_block', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=5)),
            ('block_min_duration', self.gf('django.db.models.fields.IntegerField')()),
            ('lcr_carrier_id', self.gf('django.db.models.fields.related.ForeignKey')(related_name='carrier_related', to=orm['pyfreebill.Company'])),
            ('ratecard_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.RateCard'])),
            ('lcr_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.LCRGroup'])),
            ('sip_user_agent', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('sip_rtp_rxstat', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('sip_rtp_txstat', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'pyfreebill', ['CDR'])
