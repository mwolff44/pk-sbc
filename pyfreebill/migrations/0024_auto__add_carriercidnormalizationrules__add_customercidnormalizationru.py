...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CarrierCIDNormalizationRules'
        db.create_table('carrier_cid_norm_rules', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.Company'])),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('remove_prefix', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True)),
            ('add_prefix', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'pyfreebill', ['CarrierCIDNormalizationRules'])

        # Adding model 'CustomerCIDNormalizationRules'
        db.create_table('customer_cid_norm_rules', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.Company'])),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('remove_prefix', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True)),
        ...
        db.send_create_signal(u'pyfreebill', ['CustomerCIDNormalizationRules'])


    def backwards(self, orm):
        # Deleting model 'CarrierCIDNormalizationRules'
        db.delete_table('carrier_cid_norm_rules')

        # Deleting model 'CustomerCIDNormalizationRules'
        db.delete_table('customer_cid_norm_rules')
