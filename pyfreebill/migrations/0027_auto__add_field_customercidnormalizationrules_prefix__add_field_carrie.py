...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerCIDNormalizationRules.prefix'
        db.add_column('customer_cid_norm_rules', 'prefix',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=30),
                      keep_default=False)

        # Adding field 'CarrierCIDNormalizationRules.prefix'
        db.add_column('carrier_cid_norm_rules', 'prefix',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerCIDNormalizationRules.prefix'
        db.delete_column('customer_cid_norm_rules', 'prefix')

        # Deleting field 'CarrierCIDNormalizationRules.prefix'
        db.delete_column('carrier_cid_norm_rules', 'prefix')
