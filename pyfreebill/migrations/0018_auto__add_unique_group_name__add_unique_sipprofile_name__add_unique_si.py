...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('contacts_groups', ['name'])

        # Adding unique constraint on 'SipProfile', fields ['name']
        db.create_unique('sip_profile', ['name'])

        # Adding unique constraint on 'SipProfile', fields ['sip_ip', 'sip_port']
        db.create_unique('sip_profile', ['sip_ip', 'sip_port'])

        # Adding unique constraint on 'CustomerDirectory', fields ['name']
        db.create_unique('customer_directory', ['name'])

        # Adding unique constraint on 'CustomerRates', fields ['ratecard', 'prefix']
        db.create_unique('customer_rates', ['ratecard_id', 'prefix'])

        # Adding unique constraint on 'ProviderRates', fields ['digits', 'provider_tariff']
        db.create_unique('provider_rates', ['digits', 'provider_tariff_id'])

        # Deleting field 'Company.balance'
        db.delete_column('company', 'balance')

        # Adding field 'Company.customer_balance'
        db.add_column('company', 'customer_balance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=4),
                      keep_default=False)

        # Adding field 'Company.supplier_balance'
        db.add_column('company', 'supplier_balance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=4),
                      keep_default=False)

        # Adding unique constraint on 'Company', fields ['name']
        db.create_unique('company', ['name'])

        # Deleting field 'CompanyBalanceHistory.balance'
        db.delete_column('company_balance_history', 'balance')

        # Adding field 'CompanyBalanceHistory.customer_balance'
        db.add_column('company_balance_history', 'customer_balance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=4),
                      keep_default=False)

        # Adding field 'CompanyBalanceHistory.supplier_balance'
        db.add_column('company_balance_history', 'supplier_balance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=4),
                      keep_default=False)

        # Adding field 'CompanyBalanceHistory.operation_type'
        db.add_column('company_balance_history', 'operation_type',
                      self.gf('django.db.models.fields.CharField')(default='customer', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Company', fields ['name']
        db.delete_unique('company', ['name'])

        # Removing unique constraint on 'ProviderRates', fields ['digits', 'provider_tariff']
        db.delete_unique('provider_rates', ['digits', 'provider_tariff_id'])

        # Removing unique constraint on 'CustomerRates', fields ['ratecard', 'prefix']
        db.delete_unique('customer_rates', ['ratecard_id', 'prefix'])

        # Removing unique constraint on 'CustomerDirectory', fields ['name']
        db.delete_unique('customer_directory', ['name'])

        # Removing unique constraint on 'SipProfile', fields ['sip_ip', 'sip_port']
        db.delete_unique('sip_profile', ['sip_ip', 'sip_port'])

        # Removing unique constraint on 'SipProfile', fields ['name']
        db.delete_unique('sip_profile', ['name'])

        # Removing unique constraint on 'Group', fields ['name']
        db.delete_unique('contacts_groups', ['name'])

        # Adding field 'Company.balance'
        db.add_column('company', 'balance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=4),
                      keep_default=False)

        # Deleting field 'Company.customer_balance'
        db.delete_column('company', 'customer_balance')

        # Deleting field 'Company.supplier_balance'
        db.delete_column('company', 'supplier_balance')

        # Adding field 'CompanyBalanceHistory.balance'
        db.add_column('company_balance_history', 'balance',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=4),
                      keep_default=False)

        # Deleting field 'CompanyBalanceHistory.customer_balance'
        db.delete_column('company_balance_history', 'customer_balance')

        # Deleting field 'CompanyBalanceHistory.supplier_balance'
        db.delete_column('company_balance_history', 'supplier_balance')

        # Deleting field 'CompanyBalanceHistory.operation_type'
        db.delete_column('company_balance_history', 'operation_type')
