...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DimDate.month_name'
        db.delete_column('date_dimension', 'month_name')

        # Deleting field 'DimDate.quarter_name'
        db.delete_column('date_dimension', 'quarter_name')

        # Adding field 'DimDate.hour'
        db.add_column('date_dimension', 'hour',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'DimDate.month_name'
        raise RuntimeError("Cannot reverse this migration. 'DimDate.month_name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DimDate.quarter_name'
        raise RuntimeError("Cannot reverse this migration. 'DimDate.quarter_name' and its values cannot be restored.")
        # Deleting field 'DimDate.hour'
        db.delete_column('date_dimension', 'hour')
