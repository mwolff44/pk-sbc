...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProviderTariff.callerid_filter'
        db.add_column('provider_tariff', 'callerid_filter',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=2),
                      keep_default=False)

        # Adding field 'ProviderTariff.callerid_list'
        db.add_column('provider_tariff', 'callerid_list',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.CalleridPrefixList'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProviderTariff.callerid_filter'
        db.delete_column('provider_tariff', 'callerid_filter')

        # Deleting field 'ProviderTariff.callerid_list'
        db.delete_column('provider_tariff', 'callerid_list_id')
