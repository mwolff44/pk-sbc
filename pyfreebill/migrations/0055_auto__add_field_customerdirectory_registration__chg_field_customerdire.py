...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerDirectory.registration'
        db.add_column('customer_directory', 'registration',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'CustomerDirectory.sip_ip'
        db.alter_column('customer_directory', 'sip_ip', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'CustomerDirectory.registration'
        db.delete_column('customer_directory', 'registration')


        # Changing field 'CustomerDirectory.sip_ip'
        db.alter_column('customer_directory', 'sip_ip', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'pyfreebill.customerdirectory': {
            ...
            'sip_ip': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
