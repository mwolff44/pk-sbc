...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerDirectory.ignore_early_media'
        db.add_column('customer_directory', 'ignore_early_media',
                      self.gf('django.db.models.fields.CharField')(default='false', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerDirectory.ignore_early_media'
        db.delete_column('customer_directory', 'ignore_early_media')
