...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cdr', 'sip_user_agent', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Deleting field 'Lcr.sell_rate'
        db.delete_column('lcr', 'sell_rate')

        # Deleting field 'Rates.country'
        db.delete_column('rates', 'country_id')


    def backwards(self, orm):

        # Changing field 'CDR.sip_user_agent'
        db.alter_column('cdr', 'sip_user_agent', self.gf('django.db.models.fields.CharField')(max_length=30))
        # Adding field 'Lcr.sell_rate'
        db.add_column('lcr', 'sell_rate',
                      self.gf('django.db.models.fields.DecimalField')(default='', max_digits=11, decimal_places=5, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Rates.country'
        raise RuntimeError("Cannot reverse this migration. 'Rates.country' and its values cannot be restored.")
