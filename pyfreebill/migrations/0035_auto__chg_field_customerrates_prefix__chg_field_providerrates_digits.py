...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomerRates.prefix'
        db.alter_column('customer_rates', 'prefix', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'ProviderRates.digits'
        db.alter_column('provider_rates', 'digits', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'CustomerRates.prefix'
        db.alter_column('customer_rates', 'prefix', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'ProviderRates.digits'
        db.alter_column('provider_rates', 'digits', self.gf('django.db.models.fields.CharField')(max_length=30))
