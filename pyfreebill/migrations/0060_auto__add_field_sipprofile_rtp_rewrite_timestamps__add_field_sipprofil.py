...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SipProfile.rtp_rewrite_timestamps'
        db.add_column('sip_profile', 'rtp_rewrite_timestamps',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SipProfile.pass_rfc2833'
        db.add_column('sip_profile', 'pass_rfc2833',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SipProfile.rtp_rewrite_timestamps'
        db.delete_column('sip_profile', 'rtp_rewrite_timestamps')

        # Deleting field 'SipProfile.pass_rfc2833'
        db.delete_column('sip_profile', 'pass_rfc2833')
