...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CDR.bleg_uuid'
        db.add_column('cdr', 'bleg_uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CDR.bleg_uuid'
        db.delete_column('cdr', 'bleg_uuid')
    ...
    models = {
        ...
        u'pyfreebill.cdr': {
            ...
            'answered_stamp': ('django.db.models.fields.DateTimeField', [], {}),
