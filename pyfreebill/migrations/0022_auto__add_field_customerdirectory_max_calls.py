...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerDirectory.max_calls'
        db.add_column('customer_directory', 'max_calls',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerDirectory.max_calls'
        db.delete_column('customer_directory', 'max_calls')
