...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomerRateCards.tech_prefix'
        db.alter_column('customer_ratecards', 'tech_prefix', self.gf('django.db.models.fields.CharField')(max_length=7, null=True))

    def backwards(self, orm):

        # Changing field 'CustomerRateCards.tech_prefix'
        db.alter_column('customer_ratecards', 'tech_prefix', self.gf('django.db.models.fields.CharField')(max_length=15))
