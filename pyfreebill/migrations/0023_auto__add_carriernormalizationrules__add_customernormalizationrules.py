...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CarrierNormalizationRules'
        db.create_table('carrier_norm_rules', (
        ...
        db.send_create_signal(u'pyfreebill', ['CarrierNormalizationRules'])

        # Adding model 'CustomerNormalizationRules'
        db.create_table('customer_norm_rules', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.Company'])),
            ('prefix', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        db.send_create_signal(u'pyfreebill', ['CustomerNormalizationRules'])


    def backwards(self, orm):
        # Deleting model 'CarrierNormalizationRules'
        db.delete_table('carrier_norm_rules')

        # Deleting model 'CustomerNormalizationRules'
        db.delete_table('customer_norm_rules')
