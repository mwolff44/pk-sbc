...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'DimHangupcauseDestination'
        db.delete_table('dim_hangupcause_destination')

        # Deleting field 'DimCustomerHangucause.max_duration'
        db.delete_column('dim_customer_hangupcause', 'max_duration')

        # Deleting field 'DimCustomerHangucause.total_duration'
        db.delete_column('dim_customer_hangupcause', 'total_duration')

        # Deleting field 'DimCustomerHangucause.min_duration'
        db.delete_column('dim_customer_hangupcause', 'min_duration')

        # Deleting field 'DimCustomerHangucause.avg_duration'
        db.delete_column('dim_customer_hangupcause', 'avg_duration')

        # Deleting field 'DimCustomerHangucause.total_cost'
        db.delete_column('dim_customer_hangupcause', 'total_cost')

        # Deleting field 'DimCustomerHangucause.success_calls'
        db.delete_column('dim_customer_hangupcause', 'success_calls')

        # Deleting field 'DimCustomerHangucause.total_sell'
        db.delete_column('dim_customer_hangupcause', 'total_sell')

        # Adding field 'DimCustomerHangucause.destination'
        db.add_column('dim_customer_hangupcause', 'destination',
        ...
        # Adding field 'SipProfile.user_agent'
        db.add_column('sip_profile', 'user_agent',
                      self.gf('django.db.models.fields.CharField')(default='pyfreebilling', max_length=50),
                      keep_default=False)

        # Deleting field 'DimProviderHangucause.max_duration'
        db.delete_column('dim_provider_hangupcause', 'max_duration')

        # Deleting field 'DimProviderHangucause.total_duration'
        db.delete_column('dim_provider_hangupcause', 'total_duration')

        # Deleting field 'DimProviderHangucause.min_duration'
        db.delete_column('dim_provider_hangupcause', 'min_duration')

        # Deleting field 'DimProviderHangucause.avg_duration'
        db.delete_column('dim_provider_hangupcause', 'avg_duration')

        # Deleting field 'DimProviderHangucause.total_cost'
        db.delete_column('dim_provider_hangupcause', 'total_cost')

        # Deleting field 'DimProviderHangucause.success_calls'
        db.delete_column('dim_provider_hangupcause', 'success_calls')

        # Deleting field 'DimProviderHangucause.total_sell'
        db.delete_column('dim_provider_hangupcause', 'total_sell')

        # Adding field 'DimProviderHangucause.destination'
        db.add_column('dim_provider_hangupcause', 'destination',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding model 'DimHangupcauseDestination'
        db.create_table('dim_hangupcause_destination', (
            ('max_duration', self.gf('django.db.models.fields.IntegerField')()),
            ('total_duration', self.gf('django.db.models.fields.IntegerField')()),
            ('hangupcause', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('min_duration', self.gf('django.db.models.fields.IntegerField')()),
            ...
            ('total_cost', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
            ('destination', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('success_calls', self.gf('django.db.models.fields.IntegerField')()),
            ('total_sell', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
        ))
        db.send_create_signal(u'pyfreebill', ['DimHangupcauseDestination'])


        # User chose to not deal with backwards NULL issues for 'DimCustomerHangucause.max_duration'
        raise RuntimeError("Cannot reverse this migration. 'DimCustomerHangucause.max_duration' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DimCustomerHangucause.total_duration'
        raise RuntimeError("Cannot reverse this migration. 'DimCustomerHangucause.total_duration' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DimCustomerHangucause.min_duration'
        raise RuntimeError("Cannot reverse this migration. 'DimCustomerHangucause.min_duration' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DimCustomerHangucause.avg_duration'
        raise RuntimeError("Cannot reverse this migration. 'DimCustomerHangucause.avg_duration' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DimCustomerHangucause.total_cost'
        raise RuntimeError("Cannot reverse this migration. 'DimCustomerHangucause.total_cost' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DimCustomerHangucause.success_calls'
        raise RuntimeError("Cannot reverse this migration. 'DimCustomerHangucause.success_calls' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DimCustomerHangucause.total_sell'
        raise RuntimeError("Cannot reverse this migration. 'DimCustomerHangucause.total_sell' and its values cannot be restored.")
        # Deleting field 'DimCustomerHangucause.destination'
        db.delete_column('dim_customer_hangupcause', 'destination')

        # Deleting field 'DimCustomerHangucause.sip_hangupcause'
        db.delete_column('dim_customer_hangupcause', 'sip_hangupcause')

        # Deleting field 'SipProfile.user_agent'
        db.delete_column('sip_profile', 'user_agent')


        # User chose to not deal with backwards NULL issues for 'DimProviderHangucause.max_duration'
        raise RuntimeError("Cannot reverse this migration. 'DimProviderHangucause.max_duration' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DimProviderHangucause.total_duration'
        raise RuntimeError("Cannot reverse this migration. 'DimProviderHangucause.total_duration' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DimProviderHangucause.min_duration'
        raise RuntimeError("Cannot reverse this migration. 'DimProviderHangucause.min_duration' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DimProviderHangucause.avg_duration'
        raise RuntimeError("Cannot reverse this migration. 'DimProviderHangucause.avg_duration' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DimProviderHangucause.total_cost'
        raise RuntimeError("Cannot reverse this migration. 'DimProviderHangucause.total_cost' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DimProviderHangucause.success_calls'
        raise RuntimeError("Cannot reverse this migration. 'DimProviderHangucause.success_calls' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DimProviderHangucause.total_sell'
        raise RuntimeError("Cannot reverse this migration. 'DimProviderHangucause.total_sell' and its values cannot be restored.")
        # Deleting field 'DimProviderHangucause.destination'
        db.delete_column('dim_provider_hangupcause', 'destination')
    ...
    models = {
        ...
        u'pyfreebill.customerrates': {
            ...
            'prefix': ('django.db.models.fields.CharField', [], {'max_length': '10', 'db_index': 'True'}),
        ...
        u'pyfreebill.providerrates': {
            ...
            'date_start': ('django.db.models.fields.DateTimeField', [], {}),
            'destination': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'digits': ('django.db.models.fields.CharField', [], {'max_length': '10', 'db_index': 'True'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'init_block': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '11', 'decimal_places': '5'}),
            'provider_tariff': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['pyfreebill.ProviderTariff']"})
        ...
        u'pyfreebill.sipprofile': {
            ...
            'sip_port': ('django.db.models.fields.PositiveIntegerField', [], {'default': '5060'}),
            'user_agent': ('django.db.models.fields.CharField', [], {'default': "'pyfreebilling'", 'unique': 'True', 'max_length': '50'})
        },
