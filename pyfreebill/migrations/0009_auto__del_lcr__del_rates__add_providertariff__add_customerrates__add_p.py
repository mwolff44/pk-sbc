...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProviderTariff'
        db.create_table('provider_tariff', (
        ...
        db.send_create_signal(u'pyfreebill', ['ProviderTariff'])

        # Adding model 'CustomerRates'
        db.create_table('customer_rates', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'pyfreebill', ['CustomerRates'])

        # Adding model 'ProviderRates'
        db.create_table('provider_rates', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('block_min_duration', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('init_block', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=11, decimal_places=5)),
            ('provider_tariff', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.ProviderTariff'])),
            ('date_start', self.gf('django.db.models.fields.DateTimeField')()),
            ('date_end', self.gf('django.db.models.fields.DateTimeField')()),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal(u'pyfreebill', ['ProviderRates'])

        # Adding field 'LCRGroup.provider_tariff'
        db.add_column('lcr_group', 'provider_tariff',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pyfreebill.ProviderTariff']),
                      keep_default=False)

        # Adding unique constraint on 'LCRGroup', fields ['name']
        db.create_unique('lcr_group', ['name'])

        # Adding unique constraint on 'RateCard', fields ['name']
        db.create_unique('ratecard', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'RateCard', fields ['name']
        db.delete_unique('ratecard', ['name'])

        # Removing unique constraint on 'LCRGroup', fields ['name']
        db.delete_unique('lcr_group', ['name'])
        ...
        # Deleting model 'ProviderTariff'
        db.delete_table('provider_tariff')

        # Deleting model 'CustomerRates'
        db.delete_table('customer_rates')

        # Deleting model 'ProviderRates'
        db.delete_table('provider_rates')

        # Deleting field 'LCRGroup.provider_tariff'
        db.delete_column('lcr_group', 'provider_tariff_id')
    ...
    models = {
        ...
        u'pyfreebill.cdr': {
            ...
            'sip_user_agent': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
