...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Company.enabled'
        db.delete_column('company', 'enabled')

        # Adding field 'Company.customer_enabled'
        db.add_column('company', 'customer_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Company.supplier_enabled'
        db.add_column('company', 'supplier_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Company.enabled'
        db.add_column('company', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Company.customer_enabled'
        db.delete_column('company', 'customer_enabled')

        # Deleting field 'Company.supplier_enabled'
        db.delete_column('company', 'supplier_enabled')
