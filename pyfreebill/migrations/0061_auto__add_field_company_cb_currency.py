...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'djmoney_rates.rate': {
            'Meta': {'unique_together': "((u'source', u'currency'),)", 'object_name': 'Rate'},
            'currency': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['djmoney_rates.RateSource']"}),
            'value': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '6'})
        },
        u'djmoney_rates.ratesource': {
            'Meta': {'object_name': 'RateSource'},
        ...
        u'pyfreebill.company': {
            ...
            'cb_currency': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['djmoney_rates.Rate']"}),
