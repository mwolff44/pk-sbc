...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerDirectory.fake_ring'
        db.add_column('customer_directory', 'fake_ring',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CustomerDirectory.cli_debug'
        db.add_column('customer_directory', 'cli_debug',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CustomerDirectory.vmd'
        db.add_column('customer_directory', 'vmd',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerDirectory.fake_ring'
        db.delete_column('customer_directory', 'fake_ring')

        # Deleting field 'CustomerDirectory.cli_debug'
        db.delete_column('customer_directory', 'cli_debug')

        # Deleting field 'CustomerDirectory.vmd'
        db.delete_column('customer_directory', 'vmd')
