...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerDirectory.calls_per_second'
        db.add_column('customer_directory', 'calls_per_second',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerDirectory.calls_per_second'
        db.delete_column('customer_directory', 'calls_per_second')
