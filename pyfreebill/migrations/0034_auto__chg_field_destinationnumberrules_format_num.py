...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DestinationNumberRules.format_num'
        db.alter_column('destination_norm_rules', 'format_num', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'DestinationNumberRules.format_num'
        db.alter_column('destination_norm_rules', 'format_num', self.gf('django.db.models.fields.CharField')(max_length=15))
