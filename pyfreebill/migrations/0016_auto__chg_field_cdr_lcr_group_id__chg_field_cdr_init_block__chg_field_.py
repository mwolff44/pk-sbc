...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CDR.lcr_group_id'
        db.alter_column('cdr', 'lcr_group_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.LCRGroup'], null=True))

        # Changing field 'CDR.init_block'
        db.alter_column('cdr', 'init_block', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=5))

        # Changing field 'CDR.destination_number'
        db.alter_column('cdr', 'destination_number', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'CDR.read_codec'
        db.alter_column('cdr', 'read_codec', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'CDR.prefix'
        db.alter_column('cdr', 'prefix', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'CDR.end_stamp'
        db.alter_column('cdr', 'end_stamp', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'CDR.duration'
        db.alter_column('cdr', 'duration', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CDR.sip_rtp_txstat'
        db.alter_column('cdr', 'sip_rtp_txstat', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'CDR.hangup_cause_q850'
        db.alter_column('cdr', 'hangup_cause_q850', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CDR.start_stamp'
        db.alter_column('cdr', 'start_stamp', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'CDR.uuid'
        db.alter_column('cdr', 'uuid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'CDR.rate'
        db.alter_column('cdr', 'rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=11, decimal_places=5))

        # Changing field 'CDR.gateway'
        db.alter_column('cdr', 'gateway_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.SofiaGateway'], null=True))

        # Changing field 'CDR.lcr_carrier_id'
        db.alter_column('cdr', 'lcr_carrier_id_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pyfreebill.Company']))

        # Changing field 'CDR.sip_rtp_rxstat'
        db.alter_column('cdr', 'sip_rtp_rxstat', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'CDR.caller_id_number'
        db.alter_column('cdr', 'caller_id_number', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'CDR.hangup_cause'
        db.alter_column('cdr', 'hangup_cause', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'CDR.write_codec'
        db.alter_column('cdr', 'write_codec', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'CDR.ratecard_id'
        db.alter_column('cdr', 'ratecard_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyfreebill.RateCard'], null=True))

        # Changing field 'CDR.block_min_duration'
        db.alter_column('cdr', 'block_min_duration', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CDR.customer'
        db.alter_column('cdr', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pyfreebill.Company']))

        # Changing field 'CDR.sip_user_agent'
        db.alter_column('cdr', 'sip_user_agent', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'CDR.country'
        db.alter_column('cdr', 'country', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'CDR.billsec'
        db.alter_column('cdr', 'billsec', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CDR.chan_name'
        db.alter_column('cdr', 'chan_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'CDR.effective_duration'
        db.alter_column('cdr', 'effective_duration', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CDR.customer_ip'
        db.alter_column('cdr', 'customer_ip', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CDR.lcr_group_id'
        raise RuntimeError("Cannot reverse this migration. 'CDR.lcr_group_id' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.init_block'
        raise RuntimeError("Cannot reverse this migration. 'CDR.init_block' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.destination_number'
        raise RuntimeError("Cannot reverse this migration. 'CDR.destination_number' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.read_codec'
        raise RuntimeError("Cannot reverse this migration. 'CDR.read_codec' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.prefix'
        raise RuntimeError("Cannot reverse this migration. 'CDR.prefix' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.end_stamp'
        raise RuntimeError("Cannot reverse this migration. 'CDR.end_stamp' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.duration'
        raise RuntimeError("Cannot reverse this migration. 'CDR.duration' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.sip_rtp_txstat'
        raise RuntimeError("Cannot reverse this migration. 'CDR.sip_rtp_txstat' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.hangup_cause_q850'
        raise RuntimeError("Cannot reverse this migration. 'CDR.hangup_cause_q850' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.start_stamp'
        raise RuntimeError("Cannot reverse this migration. 'CDR.start_stamp' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.uuid'
        raise RuntimeError("Cannot reverse this migration. 'CDR.uuid' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.rate'
        raise RuntimeError("Cannot reverse this migration. 'CDR.rate' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.gateway'
        raise RuntimeError("Cannot reverse this migration. 'CDR.gateway' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.lcr_carrier_id'
        raise RuntimeError("Cannot reverse this migration. 'CDR.lcr_carrier_id' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.sip_rtp_rxstat'
        raise RuntimeError("Cannot reverse this migration. 'CDR.sip_rtp_rxstat' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.caller_id_number'
        raise RuntimeError("Cannot reverse this migration. 'CDR.caller_id_number' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.hangup_cause'
        raise RuntimeError("Cannot reverse this migration. 'CDR.hangup_cause' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.write_codec'
        raise RuntimeError("Cannot reverse this migration. 'CDR.write_codec' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.ratecard_id'
        raise RuntimeError("Cannot reverse this migration. 'CDR.ratecard_id' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.block_min_duration'
        raise RuntimeError("Cannot reverse this migration. 'CDR.block_min_duration' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.customer'
        raise RuntimeError("Cannot reverse this migration. 'CDR.customer' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.sip_user_agent'
        raise RuntimeError("Cannot reverse this migration. 'CDR.sip_user_agent' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.country'
        raise RuntimeError("Cannot reverse this migration. 'CDR.country' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.billsec'
        raise RuntimeError("Cannot reverse this migration. 'CDR.billsec' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.chan_name'
        raise RuntimeError("Cannot reverse this migration. 'CDR.chan_name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.effective_duration'
        raise RuntimeError("Cannot reverse this migration. 'CDR.effective_duration' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CDR.customer_ip'
        raise RuntimeError("Cannot reverse this migration. 'CDR.customer_ip' and its values cannot be restored.")
    ...
    models = {
        ...
        u'pyfreebill.cdr': {
            ...
            'hangup_cause': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            ...
            'start_stamp': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
        ...
        u'pyfreebill.customerrates': {
            'Meta': {'ordering': "('ratecard', 'prefix', 'enabled')", 'object_name': 'CustomerRates', 'db_table': "'customer_rates'"},
        ...
        u'pyfreebill.providerrates': {
            'Meta': {'ordering': "('enabled', 'provider_tariff', 'digits')", 'object_name': 'ProviderRates', 'db_table': "'provider_rates'"},
            'block_min_duration': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
