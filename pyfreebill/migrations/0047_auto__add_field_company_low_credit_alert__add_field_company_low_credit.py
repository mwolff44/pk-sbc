...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.low_credit_alert'
        db.add_column('company', 'low_credit_alert',
                      self.gf('django.db.models.fields.DecimalField')(default='10', max_digits=12, decimal_places=4),
                      keep_default=False)

        # Adding field 'Company.low_credit_alert_sent'
        db.add_column('company', 'low_credit_alert_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Company.account_blocked_alert_sent'
        db.add_column('company', 'account_blocked_alert_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Company.email_alert'
        db.add_column('company', 'email_alert',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.low_credit_alert'
        db.delete_column('company', 'low_credit_alert')

        # Deleting field 'Company.low_credit_alert_sent'
        db.delete_column('company', 'low_credit_alert_sent')

        # Deleting field 'Company.account_blocked_alert_sent'
        db.delete_column('company', 'account_blocked_alert_sent')

        # Deleting field 'Company.email_alert'
        db.delete_column('company', 'email_alert')
    ...
    models = {
        ...
        u'pyfreebill.company': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'email_alert': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
