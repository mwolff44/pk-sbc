...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LCRProviders.lcr'
        db.add_column('lcr_providers', 'lcr',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pyfreebill.LCRGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LCRProviders.lcr'
        db.delete_column('lcr_providers', 'lcr_id')
