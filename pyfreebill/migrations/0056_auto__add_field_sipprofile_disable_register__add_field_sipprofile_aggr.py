...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SipProfile.disable_register'
        db.add_column('sip_profile', 'disable_register',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'SipProfile.aggressive_nat_detection'
        db.add_column('sip_profile', 'aggressive_nat_detection',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SipProfile.NDLB_force_rport'
        db.add_column('sip_profile', 'NDLB_force_rport',
                      self.gf('django.db.models.fields.CharField')(default='Null', max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SipProfile.NDLB_broken_auth_hash'
        db.add_column('sip_profile', 'NDLB_broken_auth_hash',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SipProfile.enable_timer'
        db.add_column('sip_profile', 'enable_timer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SipProfile.session_timeout'
        db.add_column('sip_profile', 'session_timeout',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1800),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SipProfile.disable_register'
        db.delete_column('sip_profile', 'disable_register')

        # Deleting field 'SipProfile.aggressive_nat_detection'
        db.delete_column('sip_profile', 'aggressive_nat_detection')

        # Deleting field 'SipProfile.NDLB_force_rport'
        db.delete_column('sip_profile', 'NDLB_force_rport')

        # Deleting field 'SipProfile.NDLB_broken_auth_hash'
        db.delete_column('sip_profile', 'NDLB_broken_auth_hash')

        # Deleting field 'SipProfile.enable_timer'
        db.delete_column('sip_profile', 'enable_timer')

        # Deleting field 'SipProfile.session_timeout'
        db.delete_column('sip_profile', 'session_timeout')
