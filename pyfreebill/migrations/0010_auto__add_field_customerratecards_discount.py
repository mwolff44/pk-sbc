...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerRateCards.discount'
        db.add_column('customer_ratecards', 'discount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=3, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerRateCards.discount'
        db.delete_column('customer_ratecards', 'discount')
