...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LCRProviders'
        db.create_table('lcr_providers', (
        ...
        db.send_create_signal(u'pyfreebill', ['LCRProviders'])
    ...
    def backwards(self, orm):
        # Deleting model 'LCRProviders'
        db.delete_table('lcr_providers')


        # User chose to not deal with backwards NULL issues for 'LCRGroup.provider_tariff'
        raise RuntimeError("Cannot reverse this migration. 'LCRGroup.provider_tariff' and its values cannot be restored.")
