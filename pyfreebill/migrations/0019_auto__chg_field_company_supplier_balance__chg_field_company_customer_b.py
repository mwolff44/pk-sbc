...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.supplier_balance'
        db.alter_column('company', 'supplier_balance', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=6))

        # Changing field 'Company.customer_balance'
        db.alter_column('company', 'customer_balance', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=6))

    def backwards(self, orm):

        # Changing field 'Company.supplier_balance'
        db.alter_column('company', 'supplier_balance', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=4))

        # Changing field 'Company.customer_balance'
        db.alter_column('company', 'customer_balance', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=4))
