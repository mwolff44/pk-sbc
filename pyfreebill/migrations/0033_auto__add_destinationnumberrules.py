...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DestinationNumberRules'
        db.create_table('destination_norm_rules', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('prefix', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('format_num', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'pyfreebill', ['DestinationNumberRules'])


    def backwards(self, orm):
        # Deleting model 'DestinationNumberRules'
        db.delete_table('destination_norm_rules')
    ...
    models = {
        ...
        u'pyfreebill.destinationnumberrules': {
            ...
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'format_num': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prefix': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
